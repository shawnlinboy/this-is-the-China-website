...
(async function () {
    if (document.domain.search('google') != -1) {
        ...
        */
        ...
        // change logo
        const replaceLogo = () => {
            const logo = document.querySelector('h1 a[href="/home"], a[href="/home"][aria-label="X"]');
            if (logo === null) {
                return false;
            }
            if (logo.querySelector('[data-weibo-logo="true"]') !== null) {
                return true;
            }
            ...
            logo.style.setProperty('padding', '8px', 'important');
            logo.style.setProperty('overflow', 'visible', 'important');
            logo.style.setProperty('color', 'inherit', 'important');
            const innerDiv = logo;
            ...
            innerDiv.firstElementChild?.setAttribute('data-weibo-logo', 'true');
            return true;
        };

        f_succ(replaceLogo);

        // X may rebuild the navigation during client-side routing or experiments.
